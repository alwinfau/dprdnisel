                                ...
                                <div class="px-lg-5">
                                    ...
                                    <div class="d-flex align-items-center mb-xl-5">
                                        ...
                                        <a href="{{ route('sejarah-dprd') }}"
                                            class="link-light ts-25-000 hover-bb-light">{{ $title }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="px-lg-5">
                        ...
                        <article
                            ...
                            <div class="px-3 px-sm-4 px-lg-5">
                                    ...
                                    <div class="d-flex flex-column flex-sm-row align-items-start gap-2">
                                        ...
                                        <div class="d-flex gap-2 gap-md-3 medsos">
                                            <a class="d-inline-flex justify-content-center align-items-center"
                                                ...
                                                href="https://api.whatsapp.com/send?text={{ route('visimisisekretariat') }}"
                                                target="_blank">
                                                <i class="fab fa-whatsapp"></i></a>
                                            <a class="d-inline-flex justify-content-center align-items-center"
                                                title="Share to facebook"
                                                href="https://www.facebook.com/sharer.php?u={{ route('visimisisekretariat') }}"
                                                target="_blank"><i class="fab fa-facebook-f"></i></a>
                                            <a class="d-inline-flex justify-content-center align-items-center"
                                                title="Share to twitter"
                                                href="https://twitter.com/share?url={{ route('visimisisekretariat') }}"
                                ...
                                <div class="konten">
                                    @forelse ($visimisisekretariat as $item)
                                        {!! $item->visimisi !!}
                                    @empty
