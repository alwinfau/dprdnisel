                    ...
                    <div class="px-lg-5">
                        ...
                        <article
                            ...
                            <div class="px-3 px-sm-4 px-lg-5">
                                    ...
                                    <div class="d-flex flex-column flex-sm-row align-items-start gap-2">
                                        ...
                                        <div class="d-flex gap-2 gap-md-3 medsos">
                                            <a class="d-inline-flex justify-content-center align-items-center"
                                                ...
                                                href="https://api.whatsapp.com/send?text={{ route('tugas-sekretariat') }}"
                                                target="_blank"><i class="fab fa-whatsapp"></i></a>
                                            <a class="d-inline-flex justify-content-center align-items-center"
                                                title="Share to facebook"
                                                href="https://www.facebook.com/sharer.php?u={{ route('tugas-sekretariat') }}"
                                                target="_blank"><i class="fab fa-facebook-f"></i></a>
                                            <a class="d-inline-flex justify-content-center align-items-center"
                                                title="Share to twitter"
                                                href="https://twitter.com/share?url={{ route('tugas-sekretariat') }}"
                                                target="_blank"><i class="fab fa-twitter"></i></a>
                                            <a id="btn" type="button"
                                                class="d-inline-flex justify-content-center align-items-center"
                                                title="Silahkan klik untuk COPY RUL dan kemudian bagikan."><i
                                ...
                                <div class="konten">
                                    @forelse ($tugassekretariat as $item)
                                        {!! $item->tugaspokok !!}
                                    @empty
