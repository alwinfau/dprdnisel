...
@section('judul', "{$detaildewan->namadewan}")
                            ...
                            <div class="px-4 px-xl-5">
                                ...
                                <div
                                    ...
                                    <img class="foto-person text-secondary small"
                                        src="{{ asset('foto dewan/' . $detaildewan->fotodewan) }}"
                                        alt="{{ $detaildewan->namadewan }}" />
                                            ...
                                            <div class="d-flex flex-column flex-sm-row align-items-start gap-2">
                                                ...
                                                <div class="d-flex gap-2 gap-md-3 medsos">
                                                    <a class="d-inline-flex justify-content-center align-items-center"
                                                        ...
                                                        href="https://api.whatsapp.com/send?text={{ route('detaildewan', $detaildewan->slugnama) }}"
                                                        target="_blank">
                                                        <i class="fab fa-whatsapp"></i></a>
                                                    <a class="d-inline-flex justify-content-center align-items-center"
                                                        title="Share to facebook"
                                                        href="https://www.facebook.com/sharer.php?u={{ route('detaildewan', $detaildewan->slugnama) }}"
                                                        target="_blank"><i class="fab fa-facebook-f"></i></a>
                                                    <a class="d-inline-flex justify-content-center align-items-center"
                                                        title="Share to twitter"
                                                        href="https://twitter.com/share?url={{ route('detaildewan', $detaildewan->slugnama) }}"
                                ...
                                <div class="row blok_konten">
                                    <div class="col col-12 col-md-6 mb-4">
                                        ...
                                        <div class="fw-300">{{ $detaildewan->tmptlahir }}</div>
                                        <div class="fw-300">
                                            {{ \Carbon\Carbon::parse($detaildewan->tgllahir)->translatedFormat('l, d F Y') }}
                                        </div>
                                        <div class="mb-4"></div>
                                        <div class="fw-500">Alamat</div>
                                        <div class="fw-300">{{ $detaildewan->alamat }}</div>
                                        <div class="mb-4"></div>

                                        <div class="fw-500">Jabatan</div>
                                        <div class="fw-300">{{ $detaildewan->jabatan }}</div>
                                        <div class="mb-4"></div>
                                        <div class="fw-500">Periode</div>
                                        <div class="fw-300">{{ $detaildewan->periode }}</div>
                                    </div>
                                    <div class="col col-12 col-md-6">

                                        <div class="fw-500">Fraksi</div>
                                        <div class="fw-300">{{ $detaildewan->fraksi }}</div>
                                        <div class="mb-4"></div>
                                        <div class="fw-500">Daerah Pemilihan</div>
                                        <div class="fw-300">
                                            {{ $detaildewan->dapil }}<br />
                                            {{ $detaildewan->kecamatan }}
                                        </div>
                                        <div class="mb-4"></div>
                                        <div class="fw-500">Pendidikan</div>
                                        <div class="fw-300">{{ $detaildewan->pendidikan }}</div>
                                    </div>
                                </div>
                                <!-- konten end -->
                                <div class="text-center text-lg-start mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
                                    <div class="d-inline-block format-alis fs-875-respon">
                                        <a href="{{ route('pimpinandprd') }}" class="text-white" data-toggle="tooltip"
