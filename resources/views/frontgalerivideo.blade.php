        ...
        <div class="px-4 px-xl-5 pb-4 pt-3 pb-xl-5">
            <div class="wrapall">
                <div class="d-flex align-items-center p-sm-0 ">
                    ...
                    <a href="{{ route('galerivideo') }}" class="link-dark hover-bb-dark">Publikasi</a>
                    <i class="fas fa-angle-right px-2 px-md-3"></i>
                    <a href="{{ route('galerivideo') }}" class="link-dark hover-bb-dark">{{ $title }}</a>
                </div>
                ...
                <div class="row mb-3 mb-md-4">
                    @foreach ($galerivideo as $item)
                        <div class="col col-12 col-sm-6 col-lg-4 p-2 p-xl-3">
                            <a href="{{ route('pergalerivideo', $item->slugjudulgaleri) }}"
