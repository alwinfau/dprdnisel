...
@section('judul', "{$detailberitasekretariat->judulberita}")
...
<style>
    ...
    * {
    ...
    #detil_teks #konten article {
        z-index: 1;
        position: relative;
        margin-top: -20px;
    }

    #detil_teks #konten article .judulsub {
        font-size: 125%;
    }

    #detil_teks #konten article .konten p {
        font-size: 112.5%;
        font-weight: 300;
    }
    ...
    @media (min-width: 576px) {
        /* #detil_teks .judulkait { font-size: 137.5%; } */
    }
...
@section('content')
    <main id="detil_teks" class="bg-F2F2F2 px-sm-3 px-md-4 px-lg-5 pb-4 pb-sm-5">
        <div class="wrapall">
            ...
            <div class="d-flex align-items-center px-3 p-sm-0 py-3 py-sm-3 py-xl-4">
                ...
                <a href="{{ route('beritasekretariat') }}"
                    class="link-dark hover-bb-dark">{{ $detailberitasekretariat->kategoriberita }}</a>
                <i class="fas fa-angle-right px-2 px-md-3"></i>
                <a href="{{ route('detailberitasekretariat', $detailberitasekretariat->slug) }}"
                    class="link-secondary hover-bb-dark">
                    {!! Str::substr($detailberitasekretariat->judulberita, 0, 100) !!}...
                </a>
            </div>
        </div>
        ...
        <!-- cover begin -->
        <div id="cover">
            <div class="ratio ratio-detil text-white">
                <img src="{{ asset('gambar berita/' . $detailberitasekretariat->gambarberita) }}"
                    class="of-cover radius-respon-detil" alt="dprdjabar">
                <div class="lg-00-05 px-md-3 px-lg-4 px-xl-5 radius-respon-detil">
                            ...
                            <div class="pb-5 d-flex flex-column justify-content-end h-100 p-lg-5">
                                <div class="mb-2 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
                                    <div class="d-inline-block format-alis fs-875-respon">
                                        {{ $detailberitasekretariat->kategoriberita }}
                                    </div>
                                </div>
                                <div class="h1-page fw-500 ts-25-000 mb-2 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
                                    {!! $detailberitasekretariat->judulberita !!}
                                </div>
                                <div class="haritanggal">
                                    {{ \Carbon\Carbon::parse($detailberitasekretariat->created_at)->translatedFormat('l, d F Y') }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="px-lg-5">
                ...
                <article
                    ...
                    <div class="px-3 px-sm-4 px-lg-5">
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-start gap-2">
                                ...
                                <div class="d-flex gap-2 gap-md-3 medsos">
                                    <a class="d-inline-flex justify-content-center align-items-center"
                                        ...
                                        href="https://api.whatsapp.com/send?text={{ route('detailberitasekretariat', $detailberitasekretariat->slug) }}"
                                        target="_blank">
                                        <i class="fab fa-whatsapp"></i></a>
                                    <a class="d-inline-flex justify-content-center align-items-center"
                                        title="Share to facebook"
                                        href="https://www.facebook.com/sharer.php?u={{ route('detailberitasekretariat', $detailberitasekretariat->slug) }}"
                                        target="_blank"><i class="fab fa-facebook-f"></i></a>
                                    <a class="d-inline-flex justify-content-center align-items-center"
                                        title="Share to twitter"
                                        href="https://twitter.com/share?url={{ route('detailberitasekretariat', $detailberitasekretariat->slug) }}"
                                        target="_blank"><i class="fab fa-twitter"></i></a>
                                    <a id="btn" type="button"
                                        class="d-inline-flex justify-content-center align-items-center"
                                        title="Silahkan Copy URL dan kemudian Bagikan..!"><i class="fas fa-link"></i></a>
                                    <p class="cetakurl"></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <img class="img-fluid mb-4 radius-respon"
                            src="{{ asset('gambar berita/' . $detailberitasekretariat->gambarberita) }}"
                            alt="foto" />
                        ...
                        <div class="konten">
                            <p style="margin-left:0cm; margin-right:0cm">
                                {!! $detailberitasekretariat->deskripsi !!}
                            </p>

                            <div class="mb-2 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
                                <div class="d-inline-block format-alis fs-875-respon">
                                    <a href="{{ route('beritasekretariat') }}" class="text-white">
                ...
                <div class="fs-3 fw-500 px-3 p-sm-0 pb-md-3">Berita Terkait</div>
                <div id="kait" class="row px-3 p-sm-0">
                    @foreach ($beritasekretariatterkait->take(3) as $item)
                        <div class="col col-12 col-md-4 gy-3 gy-sm-4 gy-md-0 gx-md-3 gx-xl-4">
                            <a href="{{ route('detailberitasekretariat', $item->slug) }}"
                                class="d-block ratio link-light lh-sm">
                                <img src="{{ asset('gambar berita/' . $item->gambarberita) }}"
                                    class="of-cover radius-respon shadow small" alt="thumbnail" /> <span
                                    class="d-flex flex-column lg-00-05 radius-respon justify-content-end p-4">
                                    <span class="ts-25-000 judulkait fw-500 d-block mb-2">
                                        {!! Str::substr($item->deskripsisingkat, 0, 80) !!}...
                                    </span>
