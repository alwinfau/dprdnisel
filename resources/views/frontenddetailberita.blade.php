...
@section('judul', "{$detailberita->judulberita}")
    ...
    <main id="detil_teks" class="bg-F2F2F2 px-sm-3 px-md-4 px-lg-5 pb-4 pb-sm-5">
        <div class="wrapall">
            ...
            <div class="d-flex align-items-center px-3 p-sm-0 py-3 py-sm-3 py-xl-4">
                ...
                <a href="{{ route('beritaumum') }}"
                    class="link-dark hover-bb-dark">{{ $detailberita->kategoriberita }}</a>
                <i class="fas fa-angle-right px-2 px-md-3"></i>
                <a href="{{ route('detailberitaumum', $detailberita->slug) }}" class="link-secondary hover-bb-dark">
                    {!! Str::substr($detailberita->judulberita, 0, 100) !!}...
                </a>
            </div>
        </div>
        ...
        <div id="cover">
            <div class="ratio ratio-detil text-white">
                <img src="{{ asset('gambar berita/' . $detailberita->gambarberita) }}"
                            ...
                            <div class="pb-5 d-flex flex-column justify-content-end h-100 p-lg-5">
                                <div class="mb-2 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
                                    <div class="d-inline-block format-alis fs-875-respon">
                                        {{ $detailberita->kategoriberita }}
                                    </div>
                                </div>
                                <div class="h1-page fw-500 ts-25-000 mb-2 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
                                    {!! $detailberita->judulberita !!}
                                </div>
                                <div class="haritanggal">
                                    {{ \Carbon\Carbon::parse($detailberita->created_at)->translatedFormat('l, d F Y') }}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="konten" class="px-0 px-sm-4 px-md-5">
            <div class="px-lg-5">
                ...
                <article
                    ...
                    <div class="px-3 px-sm-4 px-lg-5">
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                $('#btn').click(function() {
                                    ...
                                    $temp.remove();
                                    $(".cetakurl").text("URL Berhasiil di Copy!");
                                });
                            });
                        </script>
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-start gap-2">
                                ...
                                <div class="d-flex gap-2 gap-md-3 medsos">
                                    <a class="d-inline-flex justify-content-center align-items-center"
                                        ...
                                        href="https://api.whatsapp.com/send?text={{ route('detailberitaumum', $detailberita->slug) }}"
                                        target="_blank">
                                        <i class="fab fa-whatsapp"></i></a>
                                    <a class="d-inline-flex justify-content-center align-items-center"
                                        title="Share to facebook"
                                        href="https://www.facebook.com/sharer.php?u={{ route('detailberitaumum', $detailberita->slug) }}"
                                        target="_blank"><i class="fab fa-facebook-f"></i></a>
                                    <a class="d-inline-flex justify-content-center align-items-center"
                                        title="Share to twitter"
                                        href="https://twitter.com/share?url={{ route('detailberitaumum', $detailberita->slug) }}"
                        ...
                        <img class="img-fluid mb-4 radius-respon"
                            src="{{ asset('gambar berita/' . $detailberita->gambarberita) }}" alt="foto" />
                        <div class="border-bottom border-secondary mb-4 pb-4">
                            {!! $detailberita->judulberita !!}
                        </div>
                        <div class="konten">
                            <p style="margin-left:0cm; margin-right:0cm">
                                {!! $detailberita->deskripsi !!}
                            </p>

                            <div class="mb-2 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
                                <div class="d-inline-block format-alis fs-875-respon">
                                    <a href="{{ route('beritaumum') }}" class="text-white">
                ...
                <div id="kait" class="row px-3 p-sm-0">
                    @foreach ($beritaumumterkait->take(3) as $item)
