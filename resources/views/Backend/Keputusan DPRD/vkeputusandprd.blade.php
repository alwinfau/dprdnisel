        ...
        <div class="page-content container container-plus">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <a href="{{ route('admin.addkeputusan') }}"
                        ...
                        <tbody class="pos-rel">
                            ...
                            @forelse ($datakeputusan as $row)
                                <tr class="d-style bgc-h-default-l4">
                                    ...
                                    <td class="text-grey">
                                        <a href="{{ asset('keputusan dprd/' . $row->filekeputusan) }}" target="_blank"
                                        ...
                                        <div class="btn-group btn-group-sm radius-1">
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit"
                                                    href="{{ route('admin.editkeputusan', $row->id) }}"
                                            ...
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Hapus"
                                                    href="{{ route('admin.hapuskeputusan', $row->id) }}"
                                                    class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
