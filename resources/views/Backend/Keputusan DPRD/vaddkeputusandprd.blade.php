    ...
    <div class="page-content container container-plus">
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh" href="{{ route('admin.addtatatertib') }}"
                    type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.simpankeputusan') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Upload File Keputusan <span class="text-danger"> *)</span>
                                </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <input name="ketagorikeputusan"
                                        ...
                                        value="{{ old('ketagorikeputusan') }}"
                                        placeholder="(Misal : Penetapan Pegawai Tetap, Perubahan Struktural, dll)">
                                </div>
