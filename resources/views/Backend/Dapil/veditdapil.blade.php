    ...
    <div class="page-content container container-plus">
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh Halaman"
                    href="{{ route('admin.daftardapil', $editdapil->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahdapil', $editdapil->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="dapil" value="{{ $editdapil->dapil }}" type="text"
                                        class="form-control" id="exampleInputEmail1" placeholder="Daerah Pemilihan">
                                    @error('dapil')
                                ...
                                <div class="col-sm-10">
                                    <div class="card bcard border-1 brc-dark-l1">
                                        <div class="card-body p-0">
                                            <textarea name="kecamatan" id="summernote" name="editordata">
                                                {{ $editdapil->kecamatan }}
                                            </textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                                <div class="offset-md-2 col-md-12 text-nowrap">
                                    <a href="{{ route('admin.daftardapil') }}"
