            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.simpandapil') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="dapil" value="{{ old('dapil') }}" type="text" class="form-control"
                                        id="exampleInputEmail1" placeholder="Daerah Pemilihan">
                                    @error('dapil')
