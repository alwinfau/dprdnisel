        ...
        <div class="page-content container container-plus">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <a href="{{ route('admin.addvisimisi') }}"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">
                                                            <small class="text-muted">
                                                                ...
                                                                |
                                                                <a href="{{ route('admin.editvisimisi', $item->id) }}"
                                                                    class="text-decoration-none" data-toggle="tooltip"
                                                                    title="Edit Visimisi & Struktur">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>

                                                                <a href="{{ route('admin.hapusvisimisi', $item->id) }}"
                                                                    class="text-decoration-none" data-toggle="tooltip"
                                                                    title="Hapus Visimisi & Struktur">
                                ...
                                <div class="tab-pane text-95 px-25" id="profile16" role="tabpanel"
                                    ...
                                    @forelse ($strukturorganisasi as $item)
                                        <div class="card mb-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-12">
                                                    <img src="{{ asset('struktur organisasi/' . $item->struktur) }}"
                                                        alt="..." class="img-fluid">
                                                </div>
