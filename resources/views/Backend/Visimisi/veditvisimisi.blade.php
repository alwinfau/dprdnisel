        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editvisimisi', $updatevisimisi->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahvisimisi', $updatevisimisi->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0 col-ld-12">
                                        <textarea name="visimisi" id="summernote" name="editordata">
                                            {{ $updatevisimisi->visimisi }}
                                        </textarea>
                                    </div>
                                </div>
                                @error('visimisi')
                            ...
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Stuktur Organisasi <span class="text-danger"> *)</span>
                                </label>
                                <input type="file" name="struktur" value="{{ old('struktur') }}" class="ace-file-input"
                                    id="ace-file-input2" multiple />
                                @error('struktur')
                                    <em class="text-danger text-80">{{ $message }}</em></p>
                                @enderror
                                <img src="{{ asset('struktur organisasi/' . $updatevisimisi->struktur) }}" alt=""
                                    class="img-fluid">
                            </div>
