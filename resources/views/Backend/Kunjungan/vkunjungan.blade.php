        ...
        <div class="page-content container container-plus">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <a href="{{ route('admin.addkunjungan') }}"
                        ...
                        <tbody class="pos-rel">
                            ...
                            @forelse ($datakunjungan as $row)
                                <tr class="d-style bgc-h-default-l4">
                                    ...
                                    <td class="text-grey">
                                        {{ $row->kategorikunjungan }}
                                    </td>

                                    <td class="text-grey">
                                        Hari/Tgl:
                                        {{ \Carbon\Carbon::parse($row->tglkedatangan)->translatedFormat('l, d F Y') }}
                                        <br>
                                        Jam:
                                        {{ \Carbon\Carbon::parse($row->jam)->translatedFormat('H:i') }} wib
                                    </td>

                                    <td class="text-grey col-md-2">
                                        @if ($row->statuskunjungan == 'Pending')
                                            <img src="{{ asset('img/loading.gif') }}" alt="" width="20px">
                                            <span class="text-danger">Pending</span>
                                        @else
                                            <img src="{{ asset('img/selesai.gif') }}" alt="" width="20px">
                                    ...
                                    <td class="align-middle">
                                        <div class="btn-group btn-group-sm radius-1">
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Lihat Lampiran"
                                                    target="_blank" {{-- href="{{ route('admin.downloadkunjungan', $row->id) }}" --}}
                                                    href="{{ asset('dokumen kunjungan/' . $row->dokumenkunjungan) }}"
                                                    class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
                                                    <i class="fas fa-file-pdf text-110 text-orange-d2 mr-1"></i>
                                                    <span class="ml-1 d-md-none">Lampiran</span>
                                                </a>
                                            </span>
                                            ...
                                            @if ($row->statuskunjungan == 'Pending')
                                                <span class="d-none d-lg-inline">
                                                    <a data-toggle="tooltip" data-placement="top" title="validasi"
                                                        href="{{ route('admin.editkunjungan', $row->id) }}"
                                                        class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
                                                        <i class="fas fa-check-circle text-110 text-orange-d2 mr-1"></i>
                                                        <span class="ml-1 d-md-none">Validasi</span>
                                                    </a>
                                                </span>
                                            @endif
                                            ...
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Hapus"
                                                    href="{{ route('admin.hapuskunjungan', $row->id) }}"
                                                    class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
