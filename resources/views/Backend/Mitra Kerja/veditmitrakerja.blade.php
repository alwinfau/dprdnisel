    ...
    <div class="page-content container container-plus">
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh" href="{{ route('admin.addmitrakerja') }}"
                    type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahmitrakerja', $updatemitrakerja->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Nama AKD <span class="text-danger"> *)</span>
                                    </label>
                                </div>

                                <div class="col-sm-10">
                                    <select name="komisi" id="form-field-chosen-1"
                                        data-placeholder="Silahkan pilih komisi.."
                                        class="chosen-select form-control col-lg-12 col-md-6">
                                        <option value="{{ $updatemitrakerja->kodekomisi }}">{{ $updatemitrakerja->akd }}
                                        </option>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Nama ODP <span class="text-danger"> *)</span>
                                    </label>
                                </div>

                                <div class="col-sm-10">
                                    <input name="namaodp" value="{{ $updatemitrakerja->namaopd }}" type="text"
                                        class="form-control" id="exampleInputEmail1" placeholder="Nama ODP">
                                    @error('namaodp')
                                        <em class="text-danger text-80">{{ $message }}</em></p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Logo ODP <span class="text-danger"> *)</span>
                                    </label>

                                </div>

                                <div class="col-sm-10">
                                    <input type="file" name="logoodp" value="{{ old('logoodp') }}"
                                        class="ace-file-input" id="ace-file-input2" multiple />
                                    <img src="{{ asset('mitra kerja/' . $updatemitrakerja->logoopd) }}" class="img-fluid"
                                        alt="">
                                    @error('logoodp')
                                        <em class="text-danger text-80">{{ $message }}</em></p>
                                    @enderror
                            ...
                            <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                                <div class="offset-md-2 col-md-12 text-nowrap">
                                    <a href="{{ route('admin.daftarmitrakerja') }}"
