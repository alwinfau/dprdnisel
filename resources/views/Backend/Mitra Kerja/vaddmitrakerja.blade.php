            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.simpanmitrakerja') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Nama OPD <span class="text-danger"> *)</span>
                                    </label>
                                </div>

                                <div class="col-sm-10">
                                    <input name="namaodp" value="{{ old('namaodp') }}" type="text" class="form-control"
                                        id="exampleInputEmail1" placeholder="Nama OPD">
                                    @error('namaodp')
                                        <em class="text-danger text-80">{{ $message }}</em></p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Logo OPD <span class="text-danger"> *)</span>
                                    </label>

                                </div>

                                <div class="col-sm-10">
                                    <input type="file" name="logoodp" value="{{ old('logoodp') }}" class="ace-file-input"
