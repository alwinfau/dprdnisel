            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <a href="{{ route('admin.addkategori') }}"
                        class="btn float-left btn-h-light-danger px-4 btn-light-info btn-bold radius-1 d-inline-flex align-items-center pl-2px py-2px mb-1">
                    ...
                    <a href="{{ route('admin.daftarkategori') }}"
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <div class="btn-group btn-group-sm radius-1">
                                            <span class="d-lg-none text-nowrap">
                                                <a title="Edit" href="/hapus/{{ $row->id }}"
