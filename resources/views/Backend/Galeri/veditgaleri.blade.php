        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editgaleri', $updategaleri->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahgaleri', $updategaleri->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategorigaleri" id="select" data-placeholder="Kategori Kategori Galeri.."
                                    ...
                                    <option value="{{ $updategaleri->kategori }}">{{ $updategaleri->kategori }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input name="judul" value="{{ $updategaleri->judul }}" type="text" class="form-control"
                            ...
                            <div class="row mb-1">
                                <div class="col-lg-2">
                                    <img src="{{ asset('foto galeri/' . $updategaleri->gambargaleri) }}" alt=""
                                        class="img-fluid">
                                </div>
                                <div class="col-lg-2">
                                    <img src="{{ asset('foto galeri/' . $updategaleri->gambar1) }}" alt=""
                                        class="img-fluid">
                                </div>
                                <div class="col-lg-2">
                                    <img src="{{ asset('foto galeri/' . $updategaleri->gambar2) }}" alt=""
                                        class="img-fluid">
                                </div>
                                <div class="col-lg-2">
                                    <img src="{{ asset('foto galeri/' . $updategaleri->gambar3) }}" alt=""
                                        class="img-fluid">
                                </div>
                                <div class="col-lg-2">
                                    <img src="{{ asset('foto galeri/' . $updategaleri->gambar4) }}" alt=""
                                        class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0 col-ld-12">
                                        <textarea name="urlvideo" id="summernote2" name="editordata">
                                            {{ $updategaleri->link }}
                                        </textarea>
                                    </div>
                                </div>
...
<script>
    function kategorifunction(id, elementValue) {
        document.getElementById(id).style.display = elementValue.value == 'Foto' ? 'block' :
            'none';
    }
</script>
