        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editppid', $updateppid->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahppid', $updateppid->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Judul Dokumen PPID <span class="text-danger"> *)</span>
                                </label>
                                <input name="judulppid" value="{{ $updateppid->judulppid }}" type="text"
                                    class="form-control" id="exampleInputEmail1"
                                    placeholder="Silahkan isikan judul dokumen PPID">
                                @error('judulppid')
                            ...
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Keterangan PPID <span class="text-danger"> *)</span>
                                </label>
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0">
                                        <textarea name="keteranganppid" id="summernote" name="editordata">
                                            {{ $updateppid->keteranganppid }}
                                        </textarea>
                                    </div>
                                </div>
                                @error('keteranganppid')
                                    <em class="text-danger text-80">{{ $message }}</em></p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label for="">
                                    Kategori PPID <span class="text-danger">*)</span>
                                </label>
                                <input name="ketegorippid" value="{{ $updateppid->kategorippid }}" type="text"
                                    class="form-control" id="exampleInputEmail1"
                                    placeholder="Silahkan isikan kategori dokumen PPID">
                            ...
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Dokumen PPID<span class="text-danger"> *)</span>
                                </label>

                                <input id="fileanggaran" type="file" name="fileppid" value="{{ old('fileppid') }}"
                                ...
                                <div class="card-body p-0 shadow">
                                    <iframe src="{{ asset('dokumen ppid/' . $updateppid->fileppid) }}" frameborder="0"
