    ...
    <div class="page-content container container-plus">
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh" href="{{ route('admin.addpengumuman') }}"
                    type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.simpanpengumuman') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input name="judulpengumuman" value="{{ old('judulpengumuman') }}" type="text"
                                    class="form-control" id="exampleInputEmail1"
                                    placeholder="Silahkan isikan judul pengumuman">
                            ...
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Kategori Pengumuman<span class="text-danger"> *)</span>
                                </label>
                                <input name="kategoripengumuman" value="{{ old('kategoripengumuman') }}" type="text"
                                    class="form-control" id="exampleInputEmail1"
                                    placeholder="Silahkan isikan kategori pengumuman">
                            ...
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Upload Lampiran Pengumuman <span class="text-danger"> *)</span>
                                </label>

                                <input id="fileanggaran" type="file" name="filepengumuman"
                                    value="{{ old('filepengumuman') }}" class="form-control" accept=".pdf" multiple />
