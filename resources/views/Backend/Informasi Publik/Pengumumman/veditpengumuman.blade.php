        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editpengumuman', $updatepengumuman->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahpengumuman', $updatepengumuman->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input name="judulpengumuman" value="{{ $updatepengumuman->judulpengumuman }}"
                            ...
                            <div class="form-group">
                                ...
                                <input name="kategoripengumuman" value="{{ $updatepengumuman->kategoripengumuman }}"
                                    type="text" class="form-control" id="exampleInputEmail1"
                            ...
                            <div class="form-group">
                                ...
                                <div class="card-body p-0 shadow">
                                    <iframe
                                        src="{{ asset('dokumen pengumuman/' . $updatepengumuman->lampiranpengumuman) }}"
