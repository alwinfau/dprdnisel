        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editkinerja', $updatekinerja->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahkinerja', $updatekinerja->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf

                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Judul Dokumen Kinerja<span class="text-danger"> *)</span>
                                </label>
                                <input name="judulkinerja" value="{{ $updatekinerja->judulkinerja }}" type="text"
                            ...
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Kategori Dokumen Kinerja<span class="text-danger"> *)</span>
                                </label>
                                <input name="kategorikinerja" value="{{ $updatekinerja->kategorikinerja }}" type="text"
                                    class="form-control" id="exampleInputEmail1"
                                    placeholder="Silahkan isikan kategori dokument ">
                                @error('kategorikinerja')
                                    <em class="text-danger text-80">{{ $message }}</em></p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="fileanggaran" type="file" name="filekinerja"
                                    value="{{ old('filekinerja') }}" class="form-control" accept=".pdf" multiple />
                                @error('filekinerja')
                                    <em class="text-danger text-80">{{ $message }}</em></p>
                                @enderror

                                <div class="card-body p-0 shadow">
                                    <iframe src="{{ asset('dokumen kinerja/' . $updatekinerja->dokumenkinerja) }}"
