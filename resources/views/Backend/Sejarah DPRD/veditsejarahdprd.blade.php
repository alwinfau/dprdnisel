            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahsejarah', $editsejarah->id) }}" method="POST"
                                ...
                                <div class="col-sm-10">
                                    <div class="card bcard border-1 brc-dark-l1">
                                        <div class="card-body p-0">
                                            <textarea name="sejarah" id="summernote" name="editordata">
                                                {{ $editsejarah->sejarah }}
                                            </textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="kategori" id="form-field-chosen-1"
                                        ...
                                        <option value="{{ $editsejarah->kategori }}">
                                            {{ $editsejarah->kategori }}
                                        </option>
