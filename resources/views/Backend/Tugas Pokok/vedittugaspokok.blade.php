            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahtugaspokok', $edittugaspokok->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Tugas Pokok <span class="text-danger"> *)</span>
                                    </label>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="card bcard border-1 brc-dark-l1">
                                        <div class="card-body p-0">
                                            <textarea name="tugaspokok" id="summernote" name="editordata">
                                                {{ $edittugaspokok->tugaspokok }}
                                            </textarea>
                                        </div>
                                    </div>
                                    @error('tugaspokok')
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Kategori Tugas Pokok <span class="text-danger"> *)</span>
                                    </label>

                                </div>

                                <div class="col-sm-10">
                                    <select name="kategori" id="form-field-chosen-1"
                                        data-placeholder="Pilih Kategori Sejarah..."
                                        class="chosen-select form-control col-lg-12 col-md-6">
                                        <option value="{{ $edittugaspokok->kategoritugas }}">
                                            {{ $edittugaspokok->kategoritugas }}
                                        </option>
                            ...
                            <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                                <div class="offset-md-2 col-md-12 text-nowrap">
                                    <a href="{{ route('admin.daftarsejarah') }}"
