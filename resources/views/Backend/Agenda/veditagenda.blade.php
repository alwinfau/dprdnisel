        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editagenda', $updateagenda->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahagenda', $updateagenda->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input name="tglagenda" type="datetime-local"
                                    ...
                                    value="{{ $updateagenda->tglagenda }}" placeholder="Tanggal Agenda">
                                @error('tglagenda')
                            ...
                            <div class="form-group">
                                ...
                                <input name="lokasi" type="text"
                                    class="form-control btn-group-inside-spinner form-control-md"
                                    value="{{ $updateagenda->lokasi }}" placeholder="Lokasi Pelaksanan Agenda">
                                @error('lokasi')
                                    <p class="text-danger italic" style="font-size: 12px;">
                                        <em>{{ $message }}</em>
                                    </p>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategoriagenda" id="form-field-chosen-1"
                                    ...
                                    <option value="{{ $updateagenda->kategoriagenda }}">
                                        {{ $updateagenda->kategoriagenda }}
                                    </option>
