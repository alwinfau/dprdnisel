                        ...
                        <div class="card-body px-0 py-2">
                            <div class="tab-content tab-sliding border-0 px-0">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text small">
                                                            <i class="fas fa-calendar-alt"></i> Tanggal Agenda:
                                                            {{ \Carbon\Carbon::parse($item->tglagenda)->translatedFormat('l, d F Y') }}
                                                        </p>
                                                        <p class="card-text">
                                                            {!! Str::substr($item->deskripsiagenda, 0, 500) !!}
                                                        </p>
                                                        ...
                                                        <p class="card-text">
                                                            <small class="text-muted">
                                                                ...
                                                                |
                                                                <a href="{{ route('admin.editagenda', $item->id) }}"
                                                                    class="text-decoration-none" data-toggle="tooltip"
                                                                    title="Edit Agenda">
                                                                    <i class="fas fa-edit"></i>
                                                                </a>

                                                                <a href="{{ route('admin.hapusagenda', $item->id) }}"
                                                                    class="text-decoration-none" data-toggle="tooltip"
                                                                    title="Hapus Agenda">
                                ...
                                <div class="tab-pane text-95 px-25" id="profile16" role="tabpanel"
                                    ...
                                    @forelse ($agendasekretariat as $item)
                                        <div class="card mb-3">
                                            <div class="row no-gutters">
                                                <div class="col-md-12">
                                                    <div class="card-body">
                                    ...
                                    @empty
                                        <small>
                                            <div class="alert d-flex bgc-warning-l4 text-dark-tp3 radius-0 text-120 brc-warning-l2"
                                                ...
                                                <i class="fas fa-exclamation-circle mr-3 fa-2x text-orange-d1"></i>
                                                <span class="align-self-center">
                                                    Agenda Sekretariat Masih kosong..!!
                                                </span>
                                            </div>
                                        </small>
                                    @endforelse
