    ...
    <div class="page-content container container-plus">
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh" href="{{ route('admin.addakd') }}"
                    type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.simpanakd') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group ">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0">
                                        <textarea name="akd" id="summernote" name="editordata">
                                            {{ old('akd') }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0">
                                        <textarea name="keteranganakd" id="summernote2" name="editordata">
                                            {{ old('keteranganakd') }}
                                        </textarea>
                                    </div>
                                </div>
