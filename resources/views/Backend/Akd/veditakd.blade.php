        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.rubahakd', $editakd->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahakd', $editakd->id) }}" method="POST"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0">
                                        <textarea name="akd" id="summernote2" name="editordata">
                                            {{ $editakd->akd }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group ">
                                <label for="id-form-field-1" class="mb-0">
                                    Keterangan AKD <span class="text-danger"> *)</span>
                                </label>

                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0">
                                        <textarea name="keteranganakd" id="summernote" name="editordata">
                                            {{ $editakd->keteranganakd }}
                                        </textarea>
                                    </div>
                                </div>
                                @error('keteranganakd')
                            ...
                            <div class="form-group">
                                <label for="id-form-field-1" class="mb-0">
                                    Icon AKD (Alat Kelengkapan Dewan) <span class="text-danger"> *)</span>
                                </label>

                                <input type="file" name="iconakd" value="{{ old('iconakd') }}" class="ace-file-input"
                                    id="ace-file-input2" multiple />
                                @error('iconakd')
                                    <em class="text-danger text-80">{{ $message }}</em></p>
                                @enderror

                                <img src="{{ asset('icon akd/' . $editakd->iconakd) }}" alt=""
                                    class="img-fluid d-flex mx-auto" width="200px">
                            </div>

                            <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                                <div class="col-md-12 text-nowrap">
                                    <a href="{{ route('admin.daftarakd') }}"
