        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editberita', $updateberita->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahberita', $updateberita->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0 col-ld-12">
                                        <textarea name="judulberita" id="summernote" name="editordata">
                                        {{ $updateberita->judulberita }}
                                    </textarea>
                                    </div>
                                </div>
                                @error('judulberita')
                            ...
                            <div class="form-group">
                                ...
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0 col-ld-12">
                                        <textarea name="deskripsisingkat" id="summernote2" name="editordata">
                                        {{ $updateberita->deskripsisingkat }}
                                    </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="">
                                    Deskripsi Berita <span class="text-danger">*)</span>
                                </label>
                                <div class="card bcard border-1 brc-dark-l1">
                                    <div class="card-body p-0 col-ld-12">
                                        <textarea name="dekripsiberita" id="summernote3" name="editordata">
                                        {{ $updateberita->deskripsi }}
                                    </textarea>
                                    </div>
                                </div>
                                @error('dekripsiberita')
                                    <em class="text-danger text-80">{{ $message }}</em></p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategoriberita" id="form-field-chosen-1" data-placeholder="Kategori Berita.."
                                    class="chosen-select form-control col-lg-12 col-md-6">
                                    <option value=" {{ $updateberita->kategoriberita }}">
                                        {{ $updateberita->kategoriberita }}</option>
                                    <option value="Berita Umum">Berita Umum</option>
                                    <option value="Berita Sekretariat">Berita Sekretariat</option>
                                </select>

                                @error('kategoriberita')
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="gambarberita" value="{{ old('logo') }}"
                                    class="ace-file-input" id="ace-file-input2" multiple />
                                @error('gambarberita')
                                    <em class="text-danger text-80">{{ $message }}</em></p>
                                @enderror

                                <img src="{{ asset('gambar berita/' . $updateberita->gambarberita) }}"
