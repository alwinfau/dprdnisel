            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    ...
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.updateprofile', $datauser->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 mb-0">
                                    <input name="namauser" value="{{ $datauser->name }}" type="text" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control btn-group-inside-spinner form-control-md"
                                                type="email" value="{{ $datauser->email }}" name="emailuser"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="passworduser" type="password" class="form-control"
                                                    id="passworduser" placeholder="Masukan Password Baru...!!"
                            ...
                            {{-- @if (Auth::user()->is_admin == 2)
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 mb-0">
                                        <input name="is_admin" value="{{ $datauser->is_admin }}" type="text"
                                            class="form-control" id="exampleInputEmail1" placeholder="Nama User">
                                        @error('namauser')
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="leveluser" id="form-field-chosen-1"
                                                    ...
                                                    <option value="{{ $datauser->is_admin }}">
                                                        @if ($datauser->is_admin == 1)
                                                            Superuser
                                                        @elseif ($datauser->is_admin == 2)
                                                            Admin 1
                                                        @elseif ($datauser->is_admin == 3)
                                                            Admin 2
                                                        @elseif ($datauser->is_admin == 4)
                                                            Admin 3
                                                        @elseif ($datauser->is_admin == 5)
                                                            Admin 4
                                                        @endif
                                                    </option>
                            ...
                            @if (Auth::user()->is_admin == 2 ||
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <input type="hidden" value="{{ $datauser->is_admin }}" name="leveluser"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if ($datauser->fotoprofil == null)
                                        <img class="img-fluid mt-2" src="{{ Auth::user()->gravatar() }}" width="180px"
                                            height="180px">
                                        <br>
                                        <span class="text-danger text-80">Silahkan Upload Foto Profil Anda</span>
                                    @else
                                        <img class="img-fluid mt-2" src="{{ asset('img/' . $datauser->fotoprofil) }}"
