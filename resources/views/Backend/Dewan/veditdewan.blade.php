        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editdewan', $updatedewan->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahdewan', $updatedewan->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="namadewan" value="{{ $updatedewan->namadewan }}" type="text"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="jabatan" id="form-field-chosen-1"
                                                ...
                                                <option value="{{ $updatedewan->jabatan }}">{{ $updatedewan->jabatan }}
                                                </option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="periode" id="form-field-chosen-1"
                                                ...
                                                class="chosen-select form-control col-lg-12 col-md-6">
                                                <option value="{{ $updatedewan->periode }}">
                                                    {{ $updatedewan->periode }}
                                                </option>
                                                @php
                                                    $now = date('Y');
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name="tempatlahir"
                                                class="form-control btn-group-inside-spinner form-control-md" type="text"
                                                value="{{ $updatedewan->tmptlahir }}" placeholder="Tempat Lahir">
                                            @error('tempatlahir')
                                                <p class="text-danger italic" style="font-size: 12px;">
                                                    <em>{{ $message }}</em>
                                                </p>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name="tgllahir" type="date"
                                                ...
                                                value="{{ $updatedewan->tgllahir }}" placeholder="Tanggal Lahir">
                                            @error('tgllahir')
                                                <p class="text-danger italic" style="font-size: 12px;">
                                                    <em>{{ $message }}</em>
                                                </p>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="fraksi" id="form-field-chosen-1"
                                                ...
                                                class="chosen-select form-control col-lg-12 col-md-6">
                                                <option value="{{ $updatedewan->idfraksi }}">
                                                    {{ $updatedewan->fraksi }}
                                                </option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="jabatandifraksi" id="form-field-chosen-1"
                                                ...
                                                class="chosen-select form-control col-lg-12 col-md-6">
                                                <option value="{{ $updatedewan->jabatandifraksi }}">
                                                    {{ $updatedewan->jabatandifraksi }}
                                                </option>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="dapil" id="form-field-chosen-1"
                                                ...
                                                class="chosen-select form-control col-lg-12 col-md-6">
                                                <option value="{{ $updatedewan->iddapil }}">
                                                    {{ $updatedewan->dapil }}
                                                </option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="akd" id="form-field-chosen-1"
                                                ...
                                                class="chosen-select form-control col-lg-12 col-md-6">
                                                <option value="{{ $updatedewan->idakd }}">
                                                    {{ $updatedewan->akd }}
                                                </option>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="jabatandiakd" id="form-field-chosen-1"
                                                ...
                                                class="chosen-select form-control col-lg-12 col-md-6">
                                                <option value="{{ $updatedewan->jabatandiakd }}">
                                                    {{ $updatedewan->jabatandiakd }}
                                                </option>
                                                <option value="Ketua">Ketua</option>
                                                <option value="Wakil Ketua">Wakil Ketua</option>
                                                <option value="Sekretaris">Sekretaris</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @error('fotodewan')
                                        <p><em class="text-danger text-80">{{ $message }}</em></p>
                                    @enderror

                                    <img src="{{ asset('foto dewan/' . $updatedewan->fotodewan) }}" alt=""
