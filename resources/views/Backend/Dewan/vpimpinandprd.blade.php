                            ...
                            @forelse ($datadewan as $row)
                                <tr class="d-style bgc-h-default-l4">
                                    ...
                                    <td class="text-center col-md-2">
                                        <img src="{{ asset('foto dewan/' . $row->fotodewan) }}" alt=""
                                            class="img-fluid">
                                    </td>
                                        ...
                                        <div class="btn-group btn-group-sm radius-1">
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Detail"
                                                    href="{{ route('admin.detailanggotadprd', $row->id) }}"
                                                    class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
                                                    <i class="fas fa-eye text-110 text-orange-d2 mr-1"></i>
                                                    <span class="ml-1 d-md-none">Detail</span>
                                                </a>
                                            </span>

                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit"
                                                    href="{{ route('admin.editdewan', $row->id) }}"
                                                    class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
                                            ...
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Hapus"
                                                    href="{{ route('admin.hapusdewan', $row->id) }}"
                                                    class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
                                ...
                                <small>
                                    <div class="alert d-flex bgc-warning-l4 mt-1 text-dark-tp3 radius-0 text-120 brc-warning-l2"
                                        ...
                                        <span class="align-self-center">
                                            Data Pimpinan DPRD Masih Kosong.
                                        </span>
                                    </div>
                                </small>
                            @endforelse
