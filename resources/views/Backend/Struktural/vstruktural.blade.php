                        ...
                        <tbody class="pos-rel">
                            ...
                            @forelse ($datastruktural as $row)
                                <tr class="d-style bgc-h-default-l4">
                                    ...
                                    <td class="text-grey">
                                        <img src="{{ asset('foto struktural/' . $row->fotostruktural) }}" alt=""
                                            class="img-fluid">
                                    </td>

                                    <td class="text-grey">
                                        {{ $row->namalengkap }} ({{ $row->nip }})
                                    </td>

                                    <td class="text-grey">
                                        {{ $row->tempatlahir }},
                                        {{ \Carbon\Carbon::parse($row->tanggallahir)->translatedFormat('l, d F Y') }}
                                    </td>
                                        ...
                                        <div class="btn-group btn-group-sm radius-1">
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Edit"
                                                    href="{{ route('admin.editstruktural', $row->id) }}"
                                            ...
                                            <span class="d-none d-lg-inline">
                                                <a data-toggle="tooltip" data-placement="top" title="Hapus"
                                                    href="{{ route('admin.hapusstruktural', $row->id) }}"
                                                    class="btn btn-sm btn-outline-light btn-h-light-orange btn-a-light-orange border-b-2 text-600 px-3 mb-1">
