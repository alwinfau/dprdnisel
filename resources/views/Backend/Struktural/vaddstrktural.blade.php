    ...
    <div class="page-content container container-plus">
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh" href="{{ route('admin.addstruktural') }}"
                    type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.simpanstruktural') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="nip" value="{{ old('nip') }}" type="number" class="form-control"
                                        id="exampleInputEmail1" placeholder="Nomor Induk Kepegawaian"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="namapegawai" value="{{ old('namapegawai') }}" type="text"
                            ...
                            <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                                <div class="offset-md-2 col-md-12 text-nowrap">
                                    ...
                                    <button type="submit"
                                        ...
                                        Simpan Data Pegawai Struktural
                                    </button>
