        ...
        <div class="page-header pb-2">
            ...
            <div class="page-tools d-inline-flex">
                <a data-toggle="tooltip" data-placement="top" title="Refresh"
                    href="{{ route('admin.editstruktural', $updatestruktural->id) }}" type="button"
            ...
            <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card acard mt-lg-12 border-t-4 brc-blue-tp3">
                    <div class="card-body pb-1">
                        <form action="{{ route('admin.rubahstruktural', $updatestruktural->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="nip" value="{{ $updatestruktural->nip }}" type="number"
                                        class="form-control" id="exampleInputEmail1" placeholder="Nomor Induk Kepegawaian"
                                        onKeyPress="if(this.value.length==18) return false;" min="0">
                                    @error('nip')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input name="namapegawai" value="{{ $updatestruktural->namalengkap }}" type="text"
                                        class="form-control" id="exampleInputEmail1" placeholder="Nama Pegawai">
                                    @error('namapegawai')
                                        <em class="text-danger text-80">{{ $message }}</em></p>
                                    @enderror
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name="tempatlahir"
                                                ...
                                                value="{{ $updatestruktural->tempatlahir }}" placeholder="Tempat Lahir">
                                            @error('tempatlahir')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name="tgllahir" type="date"
                                                ...
                                                value="{{ $updatestruktural->tanggallahir }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name="pendidikan" type="text"
                                                class="form-control btn-group-inside-spinner form-control-md"
                                                value="{{ $updatestruktural->pendidikan }}"
                                                placeholder="Misal (Sarjana, Magister, dll)">
                                            @error('pendidikan')
                                                <p class="text-danger italic" style="font-size: 12px;">
                                                    <em>{{ $message }}</em>
                                                </p>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="">
                                                Jabatan Struktural <span class="text-danger"> *)</span>
                                            </label>
                                            <input name="jabatanstruktur"
                                                class="form-control btn-group-inside-spinner form-control-md" type="text"
                                                value="{{ $updatestruktural->jabatanstruktural }}"
                                                placeholder="Misalnya (Sekretaris DPRD, Kabag Umum, dll)">
                                            @error('jabatanstruktur')
                                                <p class="text-danger italic" style="font-size: 12px;">
                                                    <em>{{ $message }}</em>
                                                </p>
                                            @enderror
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <label for="id-form-field-1" class="mb-0">
                                        Foto Pegawai <span class="text-danger"> *)</span>
                                    </label>

                                </div>

                                <div class="col-sm-10">
                                    <input type="file" name="fotopegawai" value="{{ old('fotopegawai') }}"
                                        class="ace-file-input" id="ace-file-input2" multiple />
                                    @error('fotopegawai')
                                        <em class="text-danger text-80">{{ $message }}</em></p>
                                    @enderror
                                    <img src="{{ asset('foto struktural/' . $updatestruktural->fotostruktural) }}"
                            ...
                            <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                                <div class="offset-md-2 col-md-12 text-nowrap">
                                    <a href="{{ route('admin.daftarstruktural') }}"
                                    ...
                                    <button type="submit"
                                        ...
                                        Update Data Pegawai Struktural
                                    </button>
