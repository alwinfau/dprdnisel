...
! function (t, e) {
    ...
    var s = {
        ...
        c = {
            ...
            inputs: {
                text: '<label>Silahkan Pilih Obat Terlebih Dahulu..!! Terimakasih.</label>',
    ...
    function d(t, e, a, r) {
        var n;
        r && r[0] && (n = r[0].locale || u.locale, (r[0].swapButtonOrder || u.swapButtonOrder) && (e = e.reverse()));
        var i, l, s, c = {
            className: "bootbox-" + t,
            buttons: b(e, n)
        };
        return i = p(c, r, a), s = {}, h(l = e, (function (t, e) {
            s[e] = !0
    ...
    function g(t, e, a) {
        var r = !1,
            n = !0,
            i = !0;
        if ("date" === t) e === o || (n = y(e)) ? a === o || (i = y(a)) || console.warn('Browsers which natively support the "date" input type expect date values to be of the form "YYYY-MM-DD" (see ISO-8601 https://www.iso.org/iso-8601-date-and-time-format.html). Bootbox does not enforce this rule, but your max value may not be enforced by this browser.') : console.warn('Browsers which natively support the "date" input type expect date values to be of the form "YYYY-MM-DD" (see ISO-8601 https://www.iso.org/iso-8601-date-and-time-format.html). Bootbox does not enforce this rule, but your min value may not be enforced by this browser.');
        else if ("time" === t) {
            if (e !== o && !(n = N(e))) throw new Error('"min" is not a valid time. See https://www.w3.org/TR/2012/WD-html-markup-20120315/datatypes.html#form.data.time for more information.');
            if (a !== o && !(i = N(a))) throw new Error('"max" is not a valid time. See https://www.w3.org/TR/2012/WD-html-markup-20120315/datatypes.html#form.data.time for more information.')
        } else {
            if (e !== o && isNaN(e)) throw n = !1, new Error('"min" must be a valid number. See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-min for more information.');
            if (a !== o && isNaN(a)) throw i = !1, new Error('"max" must be a valid number. See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-max for more information.')
        }
        if (n && i) {
    ...
    return l.locales = function (t) {
        ...
        var t = {};
        return 2 === arguments.length ? t[arguments[0]] = arguments[1] : t = arguments[0], e.extend(u, t), l
    }, l.hideAll = function () {
        return e(".bootbox").modal("hide"), l
    }, l.init = function (o) {
        return t(o || e)
    }, l.dialog = function (t) {
        if (e.fn.modal === o) throw new Error('"$.fn.modal" is not defined; please double check you have included the Bootstrap JavaScript library. See https://getbootstrap.com/docs/4.4/getting-started/javascript/ for more details.');
        if (t = function (t) {
                var o, a;
                ...
                (t = e.extend({}, u, t)).backdrop ? t.backdrop = "string" != typeof t.backdrop || "static" !== t.backdrop.toLowerCase() || "static" : t.backdrop = !1 !== t.backdrop && 0 !== t.backdrop && "static";
                t.buttons || (t.buttons = {});
        ...
        if (i.find(".bootbox-body").html(t.message), m(t.buttons) > 0 && (h(p, (function (t, o) {
                var a = e(c.button);
            ...
            case "extra-large":
            case "xl":
                n.addClass("modal-xl"), t.fullBootstrapVersion.substring(0, 3) < "4.2" && console.warn('Using size "xl"/"extra-large" requires Bootstrap 4.2.0 or higher. You appear to be using ' + t.fullBootstrapVersion + ". Please upgrade to use this option.")
        }
        if (t.scrollable && (n.addClass("modal-dialog-scrollable"), t.fullBootstrapVersion.substring(0, 3) < "4.3" && console.warn('Using "scrollable" requires Bootstrap 4.3.0 or higher. You appear to be using ' + t.fullBootstrapVersion + ". Please upgrade to use this option.")), t.title && (i.before(l), r.find(".modal-title").html(t.title)), t.closeButton) {
            var b = e(c.closeButton);
            t.title ? t.bootstrap > 3 ? r.find(".modal-header").append(b) : r.find(".modal-header").prepend(b) : b.prependTo(i)
        }
        if (t.centerVertical && (n.addClass("modal-dialog-centered"), t.fullBootstrapVersion < "4.0.0" && console.warn('"centerVertical" requires Bootstrap 4.0.0-beta.3 or higher. You appear to be using ' + t.fullBootstrapVersion + ". Please upgrade to use this option.")), t.reusable || r.one("hide.bs.modal", {
                dialog: r
            }, w), t.onHide) {
            if (!e.isFunction(t.onHide)) throw new Error('Argument supplied to "onHide" must be a function');
            r.on("hide.bs.modal", t.onHide)
        }
        if (t.reusable || r.one("hidden.bs.modal", {
                dialog: r
            }, O), t.onHidden) {
            if (!e.isFunction(t.onHidden)) throw new Error('Argument supplied to "onHidden" must be a function');
            r.on("hidden.bs.modal", t.onHidden)
        }
        if (t.onShow) {
            if (!e.isFunction(t.onShow)) throw new Error('Argument supplied to "onShow" must be a function');
            r.on("show.bs.modal", t.onShow)
        }
        if (r.one("shown.bs.modal", {
                dialog: r
            }, C), t.onShown) {
            if (!e.isFunction(t.onShown)) throw new Error('Argument supplied to "onShown" must be a function');
            r.on("shown.bs.modal", t.onShown)
        }
        return !0 === t.backdrop && r.on("click.dismiss.bs.modal", (function (t) {
            ...
            d.onEscape && v(t, r, d.onEscape)
        })), r.on("click", ".modal-footer button:not(.disabled)", (function (t) {
            var a = e(this).data("bb-handler");
            a !== o && v(t, r, d[a])
        ...
        var t, a, r, n, i, s;
        if (r = e(c.form), (t = d("prompt", ["cancel", "confirm"], ["title", "callback"], arguments)).value || (t.value = u.value), t.inputType || (t.inputType = u.inputType), i = t.show === o ? u.show : t.show, t.show = !1, t.buttons.cancel.callback = t.onEscape = function () {
        ...
        switch (n = e(c.inputs[t.inputType]), t.inputType) {
            ...
            case "range":
                if (n.val(t.value), t.placeholder && n.attr("placeholder", t.placeholder), t.pattern && n.attr("pattern", t.pattern), t.required && n.prop({
                    ...
                    if (!("any" === t.step || !isNaN(t.step) && parseFloat(t.step) > 0)) throw new Error('"step" must be a valid positive number or the value "any". See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-step for more information.');
                    n.attr("step", t.step)
                }
                g(t.inputType, t.min, t.max) && (t.min !== o && n.attr("min", t.min), t.max !== o && n.attr("max", t.max));
                break;
            case "select":
                var p = {};
                ...
                t.placeholder && n.attr("placeholder", t.placeholder), t.required && n.prop({
                    ...
                    a.group && (p[a.group] || (p[a.group] = e("<optgroup />").attr("label", a.group)), r = p[a.group]);
                    var i = e(c.option);
        ...
        return (a = l.dialog(t)).off("shown.bs.modal", C), a.on("shown.bs.modal", (function () {
            n.focus()
        })), !0 === i && a.modal("show"), a
    }, l
}));
