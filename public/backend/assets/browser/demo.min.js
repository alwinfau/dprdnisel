"file:" != location.protocol || window.jQuery && window.bootstrap || alert("jQuery, Bootstrap and other libraries are not available!\n\nPlease run `npm install` to install them first."), window.currentLayout = 1,
    function (b) {
        b(document).on("click", 'a[href="#"]', function (e) {
            e.preventDefault()
        }), b(".sidebar .badge[title]").tooltip({
            ...
            placement: "right",
            boundary: "viewport"
        }), b(".sidebar:not(.sidebar-h) .btn[title]").tooltip({
            ...
            placement: "top",
            boundary: "viewport"
        }), b(".sidebar.sidebar-h .btn[title]").tooltip({
            ...
            placement: "bottom",
            boundary: "viewport"
        }), AceApp.EventHandler.on(document, "reload.ace.card", ".card", function (e) {
            var t = e.delegateTarget;
            setTimeout(function () {
                b(t).aceCard("stopLoading")
            }, 500 + parseInt(500 * Math.random()))
        }), b(document).on("expanded.ace.sidebar", ".sidebar.hoverable", function (e) {
            b(this).aceSidebar("disableSubmenuPullup")
        }).on("collapsed.ace.sidebar", ".sidebar.hoverable", function (e) {
            b(this).aceSidebar("enableSubmenuPullup")
        });
        var a = "white",
            r = "dark",
            n = "blue",
            ...
            l = "only-content",
            c = "auto";
        b("input[name=zoom-level]").on("change", function () {
            t(this.value)
        }), b("input[name=sidebar-theme]").on("change", function () {
            ! function (e) {
                x();
                e = e || "light";
                switch (b("#id-sidebar-themes-light , #id-sidebar-themes-dark").addClass("d-none"), e) {
                    case "light":
                        b("#id-sidebar-themes-light").removeClass("d-none");
                        break;
                    case "dark":
                        b("#id-sidebar-themes-dark").removeClass("d-none")
                }
                o(e)
            }(this.value)
        }), b("input[name=sidebar-dark]").on("change", function () {
            r = this.value, o(this.value)
        }), b("input[name=sidebar-light]").on("change", function () {
            a = this.value, o(this.value)
        }), b("#id-dropdown-select-light-theme").on("click", function () {
            b(this).button("toggle")
        }), b("input[name=sidebar-collapsed]").on("change", function () {
            var e = b(".sidebar");
        ...
        }), b("input[name=navbar-theme]").on("change", function () {
            ! function (e) {
                x();
                e = e || "blue";
                switch (b("#id-navbar-themes-light , #id-navbar-themes-dark").addClass("d-none"), e) {
                    case "light":
                        b("#id-navbar-themes-light").removeClass("d-none");
                        break;
                    case "dark":
                        b("#id-navbar-themes-dark").removeClass("d-none")
                }
                m(e)
            }(this.value)
        }), b("input[name=navbar-dark]").on("change", function () {
            n = this.value, m(this.value)
        }), b("input[name=navbar-light]").on("change", function () {
            i = this.value, m(this.value)
        }), b("input[name=body-theme]").on("change", function () {
            ! function (e) {
                x(), c = e = e || "auto";
                var t = b("body");
        ...
        }), b("#id-navbar-fixed").on("change", function () {
            document.querySelector(".navbar").classList.toggle("navbar-fixed", this.checked)
        }), b("#id-sidebar-fixed").on("change", function () {
            document.querySelector(".sidebar").classList.toggle("sidebar-fixed", this.checked)
        }), b("#id-footer-fixed").on("change", function () {
            var e = this.checked;
            b(".footer").each(function () {
                this.classList.toggle("footer-fixed", e)
            })
        }), b("#id-push-content").on("change", function () {
            document.querySelector(".sidebar").classList.toggle("sidebar-push", this.checked)
        }), b("#id-sidebar-hover").on("change", function () {
            var e = document.querySelector("#sidebar");
            e.classList.toggle("sidebar-hover", this.checked), this.checked ? b(e).aceSidebar("enableSubmenuPullup").find(".nav-item.open").removeClass("open").find(".submenu.show").removeClass("show") : b(e).aceSidebar("disableSubmenuPullup")
        }), b("input[name=boxed-layout]").on("change", function () {
            ! function e(t) {
                t = t || "none";
                l = t;
                if ("none" == t) b(".body-container, .navbar-inner, .page-content").removeClass("container container-plus"), b(".navbar-inner > .container").contents().unwrap();
                else if ("all" == t) b(".page-content").removeClass("container container-plus"), b(".body-container, .navbar-inner").addClass("container container-plus"), window.isAceLayout2 ? 0 == b(".navbar-inner > .container").length && b(".navbar-inner").wrapInner('<div class="container container-plus" />') : b(".navbar-inner > .container").contents().unwrap();
                else if ("not-navbar" == t) {
                    if (2 == window.currentLayout) return;
                    b(".navbar-inner, .page-content").removeClass("container container-plus"), b(".body-container").addClass("container container-plus"), b(".navbar-inner").wrapInner('<div class="container container-plus" />')
                } else "only-content" == t && (e("none"), b(".page-content").addClass("container container-plus"));
                "all" == t || "not-navbar" == t ? b("#id-body-bg").collapse("show") : b("#id-body-bg").collapse("hide")
            }(this.value)
        }), b("#id-rtl").on("change", function () {
            ! function (e) {
                e ? (b("html").addClass("rtl").attr("dir", "rtl"), b('link[rel=stylesheet][href*="/bootstrap.css"],link[rel=stylesheet][href*="/bootstrap.min.css"],link[rel=stylesheet][href*="/ace.css"],link[rel=stylesheet][href*="/ace.min.css"],link[rel=stylesheet][href*="/ace-themes.css"],link[rel=stylesheet][href*="/ace-themes.min.css"]').each(function () {
                    var t = b(this).attr("data-rtl") || b(this).attr("href").replace(/\/([^\/]+)$/, "/rtl/$1"),
                        a = this;
                    try {
                        y(t, "Loading RTL stylesheets ... please wait ...").then(function () {
                            b(a).attr("href", t)
                        })
                    } catch (e) {
                        b(a).attr("href", t)
                    }
                }), b(document).on("shown.bs.popover.rtl", function (e, t) {
                    b(".bs-popover-right, .bs-popover-left").each(function () {
                ...
                })) : (b("html").removeClass("rtl").attr("dir", "ltr"), b('link[rel=stylesheet][href*="/bootstrap.css"], link[rel=stylesheet][href*="/bootstrap.min.css"]').attr("href", f), b('link[rel=stylesheet][href*="/ace.css"],link[rel=stylesheet][href*="/ace.min.css"],link[rel=stylesheet][href*="/ace-themes.css"],link[rel=stylesheet][href*="/ace-themes.min.css"]').each(function () {
                    b(this).attr("href", b(this).attr("href").replace(/\/rtl\/([^\/]+)$/, "/$1"))
                }), b(document).off("shown.bs.popover.rtl"));
                b('.fa[class*="-right"],.fa[class*="-left"]').each(function () {
                ...
                }), b('[data-placement="right"],[data-placement="left]').each(function () {
                    var e = this.getAttribute("data-placement");
                    this.setAttribute("data-placement", "right" == e ? "left" : "right")
                })
            }(this.checked)
        }), b("#id-change-font").on("change", function () {
            var e, t, a;
            (e = this.value) && 0 != e.length && (b("body,html").removeClass(function (e, t) {
            ...
            })[e] && (w[e] || (t = a[e], (a = document.createElement("link")).setAttribute("rel", "stylesheet"), a.setAttribute("type", "text/css"), a.setAttribute("href", t.url), document.head.appendChild(a), (a = document.createElement("style")).innerHTML = t.rules, document.head.appendChild(a), w[e] = !0), b("body,html").addClass("font-" + e)))
        });
        var e = document.createElement("style");
        e.innerHTML = ".flex-equal-sm > * {flex: 0 1 1% !important;}\t\t\t\t\t\t @media print {#id-ace-settings-modal {display: none !important;}}\t\t\t\t\t\t @media (hover: hover) { #id-ace-settings-modal:not(.show) .aside-header > .btn:hover > .fa { animation: 0.6s fa-spin ease-in-out; }}\t\t\t\t\t\t @media screen and (prefers-reduced-motion: reduce) { #id-ace-settings-modal:not(.show) .aside-header > .btn:hover > .fa { animation: none; } }", document.head.appendChild(e);
        var t = function (e) {
            "none" == (e = e || "none") ? b("html").css("font-size", ""): b("html").css("font-size", {
                90: "0.925rem",
                110: "1.0625rem",
                120: "1.125rem"
            } [e])
        ...
        function o(e) {
            ...
            switch (! function (e) {
                ...
                }).find(".sidebar-inner").attr("class", "sidebar-inner"), e.find(".nav").removeClass("has-active-border active-on-top active-on-right has-active-arrow"), "auto" == c && b("body").removeClass(function (e, t) {
                    return (t.match(/(^|\s)body-\S+/g) || []).join("")
                });
                e.find(".sidebar-shortcuts-mini").parent().find(".btn").removeClass(function (e, t) {
                    t = t.match(/(^|\s)(btn-|radius-|border-|brc-|text-|opacity-)\S+/g);
                    return ((t = t && t.filter(function (e) {
                ...
                }), b("#sidebar-footer-bg").removeClass(function (e, t) {
                    return (t.match(/(^|\s)(bgc-|brc-)\S+/g) || []).join("")
                }), b("#sidebar-footer .btn").removeClass(function (e, t) {
                    return (t.match(/(^|\s)(btn-)\S+/g) || []).join("")
                }), 2 == window.currentLayout && (e.find(".navbar-brand, .navbar-brand span:last, .fa-leaf, img, #id-user-info a, #id-user-info div").removeClass(function (e, t) {
                    return (t.match(/(^|\s)(bgc-|brc-|text-|opacity-)\S+/g) || []).join("")
                }), e.find("#id-user-menu a, #id-user-menu a i").removeClass(function (e, t) {
                    return (t.match(/(^|\s)(btn-|bgc-|brc-|text-|opacity-|shadow-|border-|radius-)\S+/g) || []).join("")
                }))
            }(t), e) {
                case "light":
                    s(t, a);
        ...
        u.light = {
            ...
            "content-white": !0,
            "alert-2": 'This sidebar theme is more suitable for <a href="' + b('.sidebar .nav-link[href*="dashboard"]').attr("href") + '" class="btn btn-xs btn-outline-white px-1 border-0">Dashboard 1</a>',
            "user-menu": "btn-light-blue btn-brc-white btn-h-blue btn-a-blue radius-round border-2 shadow-sm",
            "user-menu-icons": "opacity-1"
        }, u.lightblue = jQuery.extend({}, u.light, {
            ...
            "content-white": !1,
            "alert-2": !1
        }), u.white2 = jQuery.extend({}, u.light, {
            navbar: "white",
            ...
            "content-white": !1,
            "alert-2": !1
        }), u.white3 = jQuery.extend({}, u.light, {
            navbar: "white",
            ...
            "content-white": !1,
            "alert-2": !1
        }), u.white4 = jQuery.extend({}, u.light, {
            navbar: "lightblue",
            ...
            "content-white": !1,
            "alert-2": !1
        }, u.green = jQuery.extend({}, u.steelblue, {
            body: "body-darkgreen",
            navbar: "darkgreen",
        ...
        }), u.blue = jQuery.extend({}, u.steelblue, {
            body: "body-darkblue",
        ...
        }), u.plum = jQuery.extend({}, u.steelblue, {
            body: "body-lightplum",
            navbar: "lightpurple",
            ...
            "search-icon": "text-white-tp2",
            "mic-icon": "text-white-tp3"
        }), u.darkblue = jQuery.extend({}, u.steelblue, {
            body: "body-lightblue",
            navbar: "skyblue",
            sidebar: "sidebar-color sidebar-darkblue",
            nav: " has-active-border active-on-right active-on-top",
            exclamation: "text-orange-l1"
        }), u.darkslategrey = jQuery.extend({}, u.steelblue, {
            ...
            exclamation: "text-orange-l2"
        }), u.darkslateblue = jQuery.extend({}, u.steelblue, {
            body: "body-img1",
            navbar: "lightpurple",
        ...
        }), u.cadetblue = jQuery.extend({}, u.steelblue, {
            body: "body-darkslategrey",
            navbar: "lightgrey",
        ...
        }), u.gradient4 = jQuery.extend({}, u.steelblue, {
            body: "body-darkblue3",
            navbar: "skyblue",
        ...
        function s(e, t) {
            var a = (a = u[t]) || u.light;
            "auto" != c || "all" != l && "not-navbar" != l || b(document.body).addClass(a.body), a.navbar && g && b("#id-auto-match").prop("checked") && (h = !1, m(a.navbar)), g = !0, a.sidebar && e.addClass(a.sidebar), a["sidebar-inner"] && e.find(".sidebar-inner").addClass(a["sidebar-inner"]), a.nav && (e.find(".nav").addClass(a.nav), e.hasClass("sidebar-h") && (e.find(".nav").addClass("active-on-top"), "light" != t && (b("#id-full-height").prop("checked", !0), e.find(".container").removeClass("align-items-xl-end"), e.find(".nav").removeClass("nav-link-rounded")), ("light" == t || 0 <= t.indexOf("white")) && e.find(".sidebar-inner").addClass("border-b-1 brc-grey-l1")));
            var r = a.shortcuts || ["btn-success opacity-2", "btn-info opacity-2", "btn-orange opacity-2", "btn-danger opacity-2"];
            if (Array.isArray(r) && 1 != r.length)
                for (var n = e.find(".sidebar-shortcuts-mini").parent(), i = 0; i < 4; i++) n.find(".btn:nth-child(" + (i + 1) + ")").addClass(r.length > i ? r[i] : r[i - r.length]);
            else e.find(".sidebar-shortcuts-mini").parent().find(".btn").addClass(Array.isArray(r) ? r[0] : r);
            if (a.exclamation && e.find(".fa-exclamation-triangle").addClass(a.exclamation), a.badge && e.find(".badge:last").addClass(a.badge), a["search-icon"] && e.find(".fa.fa-search").addClass(a["search-icon"]), a["mic-icon"] && e.find(".fa.fa-microphone").addClass(a["mic-icon"]), a.footer && !window.isAceLayout4 && b("#sidebar-footer-bg").addClass(a.footer), 2 == window.currentLayout) {
                a.brand && e.find(".navbar-brand").addClass(a.brand), a["brand-icon"] && e.find(".fa-leaf").addClass(a["brand-icon"]), a["user-img"] && e.find("img").addClass(a["user-img"]), a["user-info"] && b("#id-user-info a").addClass(a["user-info"]), a["user-desc"] && b("#id-user-info div").addClass(a["user-desc"]);
                var s = a["user-menu"],
                    o = a["user-menu-icons"];
                if (Array.isArray(s) && 1 != s.length)
                    for (i = 0; i < 3; i++) b("#id-user-menu .btn:nth-child(" + (i + 1) + ")").addClass(s.length > i ? s[i] : s[i - s.length]).find(".fa").addClass(o.length > i ? o[i] : o[i - o.length]);
                else b("#id-user-menu .btn").addClass(Array.isArray(s) ? s[0] : s).find(".fa").addClass(Array.isArray(o) ? o[0] : o);
                var d = b("#sidebar-header-brand1, #sidebar-header-brand2");
                ...
                e.removeClass(function (e, t) {
                    return (t.match(/(^|\s)(sidebar-|bgc-|bg-|brc-)\S*/g) || []).join("")
                }), a["layout2-sidebar-header"] && d.addClass(a["layout2-sidebar-header"]), a["layout2-sidebar-footer"] && (e.addClass(a["layout2-sidebar-footer"]), e.find(".btn").addClass(a["layout2-sidebar-footer-btn"] || "btn-blue btn-bold")), a.sidebar.indexOf("sidebar-color"), b(".navbar-inner").addClass("shadow-md"), "white3" == t ? b(".navbar-inner").removeClass("shadow-md") : "lightblue" == t ? b(".sidebar-inner").addClass("border-r-1 brc-default-l1") : "lightblue2" == t ? b(".sidebar-inner").addClass("border-r-1 brc-primary-l2") : "lightpurple" == t && b(".sidebar-inner").addClass("border-r-1 brc-purple-l2")
            }
            b.aceToaster.removeAll(null, !0), a["alert-" + window.currentLayout] && (window.hideAlert = window.hideAlert || function () {
                b.aceToaster.removeAll("tc"), window.alertHidden = !0
            }, window.alertHidden || b.aceToaster.add({
                placement: "tc",
                title: "Note",
                body: '<div class="position-tr w-100 h-100 bgc-black-tp8" style="z-index: -1;"></div> ' + a["alert-" + window.currentLayout] + '<label class="d-block mt-3 mb-0 bgc-white-tp9 bgc-h-black-tp9 p-1 radius-2px"><input onchange="window.hideAlert()" id="hide-alert-' + window.currentLayout + '" type="checkbox" class="text-dark brc-dark border-2" /> Don\'t show this again</label>',
                width: 480,
        ...
        function m(e) {
            ...
            switch ((t = a).removeClass(function (e, t) {
                t = t.match(/(^|\s)navbar-\S+/g);
                return ((t = t && t.filter(function (e) {
                    return !/navbar-fixed|navbar-sm|navbar-expand-lg/.test(e)
                })) || []).join("")
            }), t.find(".navbar-intro").removeClass(function (e, t) {
                return (t.match(/(^|\s)(text-|bgc-|bg-)\S+/g) || []).join("")
            }), t.find("#navbarMenu .navbar-nav > .nav").removeClass(function (e, t) {
            ...
            }).find("> a > .dropdown-caret").removeClass("d-none"), t.find(".navbar-brand, .navbar-brand span:last, .fa-leaf, .fa-search, .fa-flask, .fa-bell, #id-navbar-badge1, #id-navbar-badge2, .nav-user-name, #id-user-welcome, #navbarMenu .navbar-nav > .nav > .nav-item > .nav-link,  #navbarMenu .navbar-nav > .nav > .nav-item > .btn").removeClass(function (e, t) {
                return (t.match(/(^|\s)(btn-|bgc-|brc-|border-|text-|opacity-|m-|mx-|ml-|mr-|mt-|mb-|pl-|pr-|px-|p-|badge-)\S+/g) || []).join("")
            }), t.find(".navbar-input").removeClass(function (e, t) {
                return (t.match(/(^|\s)(radius-|border-|py-)\S+/g) || []).join("")
            ...
            }), t.find(".tmp--cloned").remove(), t.find(".dropdown-mega > .dropdown-menu").removeClass("mt-1px mt-0 border-t-0"), window.isAceLayout2 && b("#id-nav-post-btn").removeClass(function (e, t) {
                return (t.match(/(^|\s)(btn-|brc-)\S*/g) || []).join("")
            }), e) {
                case "light":
                    a.addClass("navbar-" + i), p(a, i);
                    break;
                case "dark":
                    a.addClass("navbar-" + n), p(a, n);
                    break;
                default:
                    a.addClass("navbar-" + e), p(a, e)
            }
        }

        function p(e, t) {
            var a = (a = d[t]) || d.blue;
            h && b("#id-auto-match").prop("checked") && a.sidebar && (g = !1, o(a.sidebar)), h = !0, a.intro && b(".navbar-intro").addClass(a.intro);
            var r = e.find("#navbarMenu .navbar-nav > .nav");
            a.nav && r.addClass(a.nav), a["nav-item"] && r.find("> .nav-item").addClass(a["nav-item"]);
            var n, i, s, r = e.find(".navbar-brand");
            a.brand && r.addClass(a.brand), a["brand-icon"] && r.find(".fa-leaf").addClass(a["brand-icon"]), a["brand-subtext"] && r.find("span:last").addClass(a["brand-subtext"]), a.toggler && ((r = e.find('[data-toggle="sidebar"] , [data-toggle-mobile="sidebar"]')).addClass(Array.isArray(a.toggler) ? a.toggler[0] : a.toggler).addClass("btn-burger"), Array.isArray(a.toggler), a.toggler[1] && r.find(".bars").addClass(a.toggler[1])), a.search && e.find('[data-target="#navbarSearch"]').addClass(a.search), a["navbar-input"] && e.find(".navbar-input").addClass(a["navbar-input"]), a["search-icon"] && e.find(".fa.fa-search").addClass(a["search-icon"]), a["nav-item-flask"] && (s = e.find(".fa-flask").parent(), (n = a["nav-item-flask"].match(/btn-(\w|\-)+/)) && ((i = s.clone().insertAfter(s).addClass("d-lg-none tmp--cloned")).addClass("nav-link"), s.addClass("d-none d-lg-flex"), i.find(".fa").eq(0).addClass(n[0].replace("outline-", "") + " radius-round w-4 h-4 text-center pt-2")), s.removeClass("nav-link").addClass(a["nav-item-flask"])), a["nav-item-bell"] && (s = e.find(".fa-bell").parent(), (n = a["nav-item-bell"].match(/btn-(\w|\-)+/)) && ((i = s.clone().insertAfter(s).addClass("d-lg-none tmp--cloned")).addClass("nav-link"), s.addClass("d-none d-lg-flex"), i.find(".fa").eq(0).addClass(n[0].replace("outline-", "") + " radius-round w-4 h-4 text-center pt-2")), s.removeClass("nav-link").addClass(a["nav-item-bell"])), a["badge-bell"] && e.find("#id-navbar-badge1").addClass(a["badge-bell"]), a["badge-flask"] && e.find("#id-navbar-badge2").addClass(a["badge-flask"]), a["bell-icon"] && e.find(".fa-bell").addClass(a["bell-icon"]), a["flask-icon"] && e.find(".fa-flask").addClass(a["flask-icon"]), a["user-image"] && e.find("#id-navbar-user-image , .navbar-toggler img").addClass(a["user-image"]), a["user-name"] && e.find(".nav-user-name").addClass(a["user-name"]), a["user-welcome"] && e.find("#id-user-welcome").addClass(a["user-welcome"]), a.mega && e.find(".dropdown-mega > .dropdown-menu").addClass(a.mega), "lightgrey" == t ? ((t = (s = e.find(".navbar-brand").removeClass("d-none d-lg-block")).clone()).removeClass("text-white-tp1").addClass("text-dark-tp4 d-lg-none tmp--cloned").find(".fa-leaf").addClass("text-success-m1"), s.addClass("d-none d-lg-block"), s.after(t), t = (s = e.find(".btn-burger[data-toggle-mobile=sidebar]").find(".bars")).clone().removeClass("text-white-tp1 d-none").addClass("text-dark-tp4 d-lg-none tmp--cloned"), s.addClass("d-none d-lg-block").after(t), window.isAceLayout2 && e.find(".btn-burger[data-toggle=sidebar]").addClass("btn-light-success btn-bold").find(".bars").removeClass("text-white-tp1").addClass("text-dark-tp4")) : e.find(".navbar-brand , .btn-burger[data-toggle-mobile=sidebar] .bars").removeClass("d-none d-lg-block"), window.isAceLayout2 && a.button && b("#id-nav-post-btn").addClass(a.button + " btn-bold btn-sm")
        }
        d.blue = {
            sidebar: "light",
            brand: "text-white",
        ...
        }), d.darkgreen = jQuery.extend({}, d.blue, {
            sidebar: "dark2",
            nav: "nav-compact has-active-border mr-1",
            "nav-item": "mr-lg-1",
        ...
        }), d.skyblue = jQuery.extend({}, d.blue, {
            sidebar: "darkblue",
        ...
        }), d.white2 = jQuery.extend({}, d.white, {
        ...
        var f = "";
        b('link[rel=stylesheet][href*="/bootstrap.css"], link[rel=stylesheet][href*="/bootstrap.min.css"]').each(function () {
            var e = b(this).attr("href");
            b(this).attr("data-rtl", -1 == e.indexOf(".min.css") ? "./dist/css/rtl/bootstrap.css" : "./dist/css/rtl/bootstrap.min.css"), f = b(this).attr("href")
        });
        var v = {};
        ...
        function y(n, i) {
            return new Promise(function (e, t) {
                var a, r;
                "file:" == location.protocol || v[n] ? e() : ((a = document.createElement("DIV")).innerHTML = '<div style="position: fixed !important; z-index: 2000; padding-top: 10rem;"\t\t\t\t\t\tclass="bgc-white position-tl w-100 h-100 text-center text-150 text-primary-m1">' + i + "</div>", document.body.appendChild(a), r = n, new Promise(function (e, t) {
        ...
        function x() {
            var t = "";
            if (b('link[rel=stylesheet][href*="/ace.css"],link[rel=stylesheet][href*="/ace.min.css"]').each(function () {
                    t = b(this).attr("href").replace("ace.", "ace-themes.")
                }), !(0 < b('link[rel=stylesheet][href*="' + t + '"]').length)) {
                function a(e) {
                    var t = document.createElement("link");
                    t.setAttribute("rel", "stylesheet"), t.setAttribute("type", "text/css"), t.setAttribute("href", e), document.head.appendChild(t)
                }
                try {
                    y(t, "Loading themes stylesheet ... please wait ...").then(function () {
                        a(t)
                    })
                } catch (e) {
                    a(t)
        ...
        var w = {}
    }(window.jQuery), window.Chart && (window.Chart.elements.Rectangle.prototype.draw = function () {
        var e, t, a, r, n, i, s, o, d, b, l = this._chart.ctx,
            c = this._view,
            u = c.borderWidth,
            h = this._chart.config.options.cornerRadius;
        "undefined" == typeof (h = h < 0 ? 0 : h) && (h = 0), n = c.horizontal ? (e = c.base, t = c.x, a = c.y - c.height / 2, r = c.y + c.height / 2, o = e < t ? 1 : -1, s = 1, c.borderSkipped || "left") : (e = c.x - c.width / 2, t = c.x + c.width / 2, o = 1, s = (a = c.y) < (r = c.base) ? 1 : -1, c.borderSkipped || "bottom"), u && (i = (u = (b = Math.min(Math.abs(e - t), Math.abs(a - r))) < u ? b : u) / 2, d = a + ("top" !== n ? i * s : 0), b = r + ("bottom" !== n ? -i * s : 0), (s = e + ("left" !== n ? i * o : 0)) !== (o = t + ("right" !== n ? -i * o : 0)) && (a = d, r = b), d !== b && (e = s, t = o)), l.beginPath(), l.fillStyle = c.backgroundColor, l.strokeStyle = c.borderColor, l.lineWidth = u;
        var g = [
                [e, r],
                [e, a],
                [t, a],
        ...
        for (var v = 1; v < 4; v++) {
            var w, f = p(v);
            nextCornerId = v + 1, 4 == nextCornerId && (nextCornerId = 0), nextCorner = p(nextCornerId), width = g[2][0] - g[1][0], height = g[0][1] - g[1][1], x = g[1][0], y = g[1][1], (w = (w = h) > Math.abs(height) / 2 ? Math.floor(Math.abs(height) / 2) : w) > Math.abs(width) / 2 && (w = Math.floor(Math.abs(width) / 2)), height < 0 ? (x_tl = x, x_tr = x + width, y_tl = y + height, y_tr = y + height, x_bl = x, x_br = x + width, y_bl = y, y_br = y, l.moveTo(x_bl + w, y_bl), l.lineTo(x_br - w, y_br), l.quadraticCurveTo(x_br, y_br, x_br, y_br - w), l.lineTo(x_tr, y_tr + w), l.quadraticCurveTo(x_tr, y_tr, x_tr - w, y_tr), l.lineTo(x_tl + w, y_tl), l.quadraticCurveTo(x_tl, y_tl, x_tl, y_tl + w), l.lineTo(x_bl, y_bl - w), l.quadraticCurveTo(x_bl, y_bl, x_bl + w, y_bl)) : width < 0 ? (x_tl = x + width, x_tr = x, y_tl = y, y_tr = y, x_bl = x + width, x_br = x, y_bl = y + height, y_br = y + height, l.moveTo(x_bl + w, y_bl), l.lineTo(x_br - w, y_br), l.quadraticCurveTo(x_br, y_br, x_br, y_br - w), l.lineTo(x_tr, y_tr + w), l.quadraticCurveTo(x_tr, y_tr, x_tr - w, y_tr), l.lineTo(x_tl + w, y_tl), l.quadraticCurveTo(x_tl, y_tl, x_tl, y_tl + w), l.lineTo(x_bl, y_bl - w), l.quadraticCurveTo(x_bl, y_bl, x_bl + w, y_bl)) : (l.moveTo(x + w, y), l.lineTo(x + width - w, y), l.quadraticCurveTo(x + width, y, x + width, y + w), l.lineTo(x + width, y + height - w), l.quadraticCurveTo(x + width, y + height, +(x + width), y + height), l.lineTo(x + w, y + height), l.quadraticCurveTo(x, y + height, x, +(y + height)), l.lineTo(x, y + w), l.quadraticCurveTo(x, y, x + w, y))
        }
        l.fill(), u && l.stroke()
    });